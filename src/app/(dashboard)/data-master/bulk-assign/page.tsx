    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent>
                    <div className="flex flex-wrap gap-4 items-end">
                        ...
                        {(filters.noKelas || filters.noHalaqoh) && (
            ...
            {selectedIds.length > 0 && (
                <div className="sticky top-4 z-10 bg-white p-4 border rounded-lg shadow-lg flex flex-wrap items-center justify-between gap-4 animate-in slide-in-from-top-2">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {loading ? (
                                ...
                                santriList.map((s) => (
                                    <TableRow key={s.id} className={selectedIds.includes(s.id) ? "bg-blue-50" : ""}>
                                        <TableCell>
                                            <input
                                                type="checkbox"
                                                className="w-4 h-4 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500"
